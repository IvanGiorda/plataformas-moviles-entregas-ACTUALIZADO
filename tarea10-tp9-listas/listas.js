...
function enumerarLista(listaDePalabras) {
    ...
    if (listaDePalabras.length === 1) return listaDePalabras[0].charAt(0).toUpperCase() + listaDePalabras[0].slice(1) + ".";
    let oracion = listaDePalabras.slice(0, -1).join(", ") + " y " + listaDePalabras[listaDePalabras.length - 1];
